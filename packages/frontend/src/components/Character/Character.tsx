...
import { Character as CharacterType } from '../../api/generated';
import { useAppContext } from '../../providers/AppContext';

const { Paragraph } = Typography;

type CharacterInternalProps = {
  character: CharacterType;
};

const CharacterInternal = ({ character }: CharacterInternalProps) => {
  const { bookmarkCharacter, unbookmarkCharacter } = useAppContext();
...
export const Character = (props: CharacterInternalProps) => {
