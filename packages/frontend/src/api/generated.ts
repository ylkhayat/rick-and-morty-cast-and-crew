...
export type BookmarkCharacterResult = {
  __typename?: 'BookmarkCharacterResult';
...
export type UnbookmarkCharacterResult = {
  __typename?: 'UnbookmarkCharacterResult';
  total: Scalars['Int']['output'];
...
export type CharacterFragment = { __typename?: 'Character', gender: string, id: number, image: string, dimension: string, name: string, origin: string, species: string, status: string, isBookmarked: boolean, episodes: Array<{ __typename?: 'Episode', id: number, name: string, airDate: string }> };

export type EpisodeFragment = { __typename?: 'Episode', id: number, name: string, airDate: string };
...
export type BookmarkCharacterMutation = { __typename?: 'Mutation', bookmarkCharacter: { __typename?: 'BookmarkCharacterResult', total: number, bookmarkedCharacter: { __typename?: 'Bookmark', id: number, character: { __typename?: 'Character', id: number, name: string } } } };
...
export type UnbookmarkCharacterMutation = { __typename?: 'Mutation', unbookmarkCharacter: { __typename?: 'UnbookmarkCharacterResult', total: number, unbookmarkedCharacter: { __typename?: 'Bookmark', id: number, character: { __typename?: 'Character', id: number, name: string } } } };
...
export type BookmarksQuery = { __typename?: 'Query', bookmarks: { __typename?: 'BookmarkResults', total: number, results: Array<{ __typename?: 'Bookmark', id: number, character: { __typename?: 'Character', gender: string, id: number, image: string, dimension: string, name: string, origin: string, species: string, status: string, isBookmarked: boolean, episodes: Array<{ __typename?: 'Episode', id: number, name: string, airDate: string }> } }> } };
...
export type CharactersQuery = { __typename?: 'Query', characters: { __typename?: 'CharacterResults', total: number, results: Array<{ __typename?: 'Character', gender: string, id: number, image: string, dimension: string, name: string, origin: string, species: string, status: string, isBookmarked: boolean, episodes: Array<{ __typename?: 'Episode', id: number, name: string, airDate: string }> }> } };
